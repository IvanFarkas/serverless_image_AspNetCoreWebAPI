...
/// The Lambda handler field should be set to serverless_image_AspNetCoreWebAPI::serverless_image_AspNetCoreWebAPI.LambdaEntryPoint::FunctionHandlerAsync
/// </summary>
public class LambdaEntryPoint :
  // The base class must be set to match the AWS service invoking the Lambda function.
  // If not Amazon.Lambda.AspNetCoreServer will fail to convert the incoming request correctly into a valid ASP.NET Core request.
  //
  ...
  // REST API, 1.0 payload format
  // APIGatewayProxyFunction

  // HTTP API, 2.0 payload format
  // In serverless.template update
  //   "Type": "Api" to "Type": "HttpApi"
  //   ${ServerlessRestApi} to ${ServerlessHttpApi}
